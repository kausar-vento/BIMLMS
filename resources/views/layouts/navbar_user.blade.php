            ...
            <div class="align-self-center collapse navbar-collapse flex-fill  d-lg-flex justify-content-lg-between" id="templatemo_main_nav">
                <div class="flex-fill">
                    <ul class="nav navbar-nav d-flex justify-content-between mx-lg-auto">
                        <li class="nav-item">
                            <a class="nav-link" href="/user/kelas">Kelas</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link" href="/course/allcourses">Courses</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link" href="/user/history">Transaksi</a>
                        </li>
                    </ul>
                </div>
                ...
                <div class="row pt-2">
                    <div class="col-12">
                        {{-- <p class="text-left text-light">
                            ...
                            | Designed by <a rel="sponsored" href="#" target="_blank">Al Kausar</a>
                        </p> --}}
                    </div>
                </div>
            </div>
